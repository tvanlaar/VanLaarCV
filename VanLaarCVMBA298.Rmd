...
name: Tricia
surname: Van Laar
position: "Associate Professor of Microbial Genomics"
...
tribble(
  ...
  "MBA", "California State University, Fresno", "Fresno, CA", "Expected 2024", 
    list("Course work in Human Resources, New Venture Management, and Strategic Marketing\\vspace{5mm}"),
  ...
  "Ph.D. in Biology with an emphasis in Cell and Molecular Biology", "The University of Texas at San Antonio", "San Antonio, TX", "2012", 
    list("Dissertation Project: Role of the mevalonate pathway in the patho-physiology of \\textit{Borrelia burgdorferi}",
         "Major Advisor: J. Seshu, Ph.D.\\vspace{5mm}"),
  ...
  "MS in Biology", "University of the Pacific", "Stockton, CA", "2007", 
    list("Thesis Project: The behavior of Rad51D and XRCC2 in response to drug induced DNA damage and a continuing study of the fly Rad51 paralogs",
          "Major Advisor: Lisa Wrischnik, Ph.D.\\vspace{5mm}"),
...
tribble(
  ...
  "Associate Professor of Microbial Genomics", "California State University, Stanislaus", "Turlock, CA", "08/2024-Present",
  "Assistant Professor of Microbial Genomics", "California State University, Stanislaus", "Turlock, CA", "08/2022-08/2024", 
...
tribble(
  ...
  "Investigating Microbiome and Immune Response Dynamics during Avian Malaria Infection in Migratory Birds", "Research, Scholarship, and Creative Activities Celebration", "Stanislaus State", "2024",
  ...
  "The Birds of Fresno State", "Monthly Meeting", "Fresno Audubon Society", "2020",
...
# Grants and Funding (Total funding: $819,891)

Stanislaus State
```{r}
tribble(
  ~ award, ~ year, ~ amount,
  "CSUBIOTECH New Investigator Grant", "2024", "15,000",
...
Stanislaus State
\begin{itemize}
\item Pre-Health Advisor (2024-Present)
...
I am passionate about improving recruitment and retention of a diversity faculty in STEM (and other) fields. I am interesting in eventually taking an administrative role in this area, such as an AVP of Faculty Affairs. Therefore I would be particularly interested in any project with a human resources or science component.

For this assignment, I would like to work with Yuliya, Elizabeth, and Sadie if possible as I know we will work well together. 
